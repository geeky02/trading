                            ...
                            <div className="flex flex-col gap-y-4 overflow-y-auto p-6">
                                {wallets.map((item) => (
                                    <button
                                        ...
                                        className={`text-md flex cursor-pointer items-center gap-x-3 overflow-auto rounded-xl border-2 p-5 shadow-white dark:text-white ${selectedAccount === item ? "border-green-500" : "border-black dark:border-white-600 "}`}
                                    >
                                        <CheckCircleIcon
